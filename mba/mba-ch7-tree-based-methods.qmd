...
knitr::include_graphics('https://bcdanl.github.io/lec_figs/tree_rain.png')
```
...
```{r, fig.align='center', echo = F}
knitr::include_graphics('https://bcdanl.github.io/lec_figs/bootstrap-scheme.png')
```
...
```{r, fig.align='center', echo = F}
knitr::include_graphics('https://bcdanl.github.io/lec_figs/pds_fig10_5.png')
```
...
```{r, fig.align='center', echo = F}
knitr::include_graphics('https://bcdanl.github.io/lec_figs/pds_fig10_6.png')
```
...
```{r, echo = F}
knitr::include_graphics('https://bcdanl.github.io/lec_figs/pds_fig10_7.png')
```
...
```{r, echo = F}
knitr::include_graphics('https://bcdanl.github.io/lec_figs/pds_fig10_8.png')
```
